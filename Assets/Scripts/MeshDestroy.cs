...
/*
 This code is for Procedural building destroy.
 The original code came from this Youtube Video: https://www.youtube.com/watch?v=VwGiwDLQ40A.
 I made an edit to the meshed UVs. Make the slicing plane show only one colour.
 I added the building Height detection + Scoring functionality to this code.
 
 My initial building destruction functionality is documented in the Building.cs + Player.cs script, 
 the principle is that when a building is collided by the player, instantiate a destroyed version of the building model.

 However, due to the large size of the map, I couldn't manually edit each building model (there are hundreds of destructible models!).
 I chose to use this procedural destroy script, which saves me a lot of time.
 
 I can't fully understand everything in this code at the moment, 
 but I'll keep working on it and try to code a better Procedural Destroy!
*/
public class MeshDestroy : MonoBehaviour
{
    ...
    void Start()
    {
        building = GetComponent<MeshCollider>();
    ...
    public void DestroyMesh()
    {
        ...
        // Vector2[] uvs = new Vector2[originalMesh.vertices.Length];
    ...
    private PartMesh GenerateMesh(PartMesh original, Plane plane, bool left)
    {
        ...
        for (var i = 0; i < original.Triangles.Length; i++)
        {
            ...
            for (var j = 0; j < triangles.Length; j = j + 3)
            {
                ...
                Vector2 randomUV1 = new Vector2(Random.Range(0f, 1f), Random.Range(0f, 1f));
                Vector2 randomUV2 = new Vector2(Random.Range(0f, 1f), Random.Range(0f, 1f));
                Vector2 randomUV3 = new Vector2(Random.Range(0f, 1f), Random.Range(0f, 1f));
